...
export const Introduction = () => (
  <Page>
    <H1Big>Alphabot Storybook</H1Big>
    <Paragraph>
      The alphabot storybook is a tool that helps visualize the structure of the
      alphabot frontend code.
      <br />
      In other words it's used to view our{" "}
      <strong>alphabot design system</strong>.
    </Paragraph>
    <Paragraph>
